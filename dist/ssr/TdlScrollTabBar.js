...
const TdlScrollTabBar = {
  ...
  mounted() {
    this.$nextTick(() => {
      this.parentBar = getClosestVueParent.getClosestVueParent(this.$parent, 'tdl-app-bar');
...
var __vue_render__ = function () {
  ...
  }, [_vm._ssrNode("<div class=\"tdl-scroll-tab-bar\">", "</div>", [_vm._t("default"), _vm._ssrNode(" <span class=\"tdl-scroll-tab-bar-indicator\"" + _vm._ssrStyle(null, _vm.indicatorStyles, null) + "></span>")], 2)]);
};
...
const __vue_module_identifier__ = "data-v-5859366e";
/* functional template */
