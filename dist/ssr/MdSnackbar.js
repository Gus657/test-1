...
const MdSnackbar = {
  ...
  data() {
    return {
      snackbarId: this.id || 'snackbar-' + uniqueId.uniqueId(),
  ...
  methods: {
    ...
    close() {
      if (this.$refs.container) {
        ...
        const removeElement = () => {
          document.removeEventListener(transitionEndEventName.transitionEndEventName, removeElement);
          this.removeElement();
        };
        ...
        this.$emit('close');
        document.removeEventListener(transitionEndEventName.transitionEndEventName, removeElement);
        document.addEventListener(transitionEndEventName.transitionEndEventName, removeElement);
...
var __vue_render__ = function () {
  ...
  }, [_vm._ssrNode("<div class=\"md-snackbar-container\">", "</div>", [_vm._ssrNode("<div class=\"md-snackbar-content\">", "</div>", [_vm._t("default")], 2)])]);
};
...
const __vue_module_identifier__ = "data-v-d4755d78";
/* functional template */
