...
var TdlTypeaheadCommon = {
  ...
  beforeDestroy() {
    ...
    document.removeEventListener('wheel', this.preventScroll, supportsPassive ? {
      passive: false
    } : false);
    document.removeEventListener('touchmove', this.preventScroll, supportsPassive ? {
      passive: false
    } : false);
  },
  ...
  methods: {
    ...
    disableScroll(node) {
      if (this.scrollEnabled) {
        ...
        document.addEventListener('wheel', this.preventScroll, supportsPassive ? {
          passive: false
        } : false);
        document.addEventListener('touchmove', this.preventScroll, supportsPassive ? {
          passive: false
        } : false);
...
exports.TdlTypeaheadCommon = TdlTypeaheadCommon;
