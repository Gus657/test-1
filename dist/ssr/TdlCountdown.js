...
var __vue_render__ = function () {
  ...
  }, [!_vm.inline && _vm.label ? _vm._ssrNode("<div" + _vm._ssrClass(null, ['tdl-countdown__label', _vm.labelClass]) + " data-v-59262732>", "</div>", [_vm._ssrNode("<span data-v-59262732>", "</span>", [_vm.labelIconset ? _c('md-icon', {
    attrs: {
      "md-iconset": _vm.labelIconset
    }
  }) : _vm._e()], 1), _vm._ssrNode(" <label data-v-59262732>" + _vm._ssrEscape(_vm._s(_vm.label)) + "</label>")], 2) : _vm._e(), _vm._ssrNode(" "), _vm._ssrNode("<div" + _vm._ssrClass(null, ['tdl-countdown__timer timer', {
    'timer--has-icon': _vm.label && _vm.labelIconset
  }]) + " data-v-59262732>", "</div>", [_vm._ssrNode((_vm.inline && _vm.label ? "<span" + _vm._ssrClass(null, ['tdl-countdown__label--inline', _vm.labelClass]) + " data-v-59262732>" + _vm._ssrEscape(_vm._s(_vm.label)) + "</span>" : "<!---->") + " <span class=\"timer__box\" data-v-59262732><div class=\"timer__number\" data-v-59262732>" + _vm._ssrEscape(_vm._s(_vm.time.days)) + "</div> " + (_vm.time.days != 1 ? "<div class=\"timer__small\" data-v-59262732>" + _vm._ssrEscape(_vm._s(_vm.$t("days"))) + "</div>" : "<div class=\"timer__small\" data-v-59262732>" + _vm._ssrEscape(_vm._s(_vm.$t("day"))) + "</div>") + "</span> <span class=\"timer__separator\" data-v-59262732></span> <span class=\"timer__box\" data-v-59262732><div class=\"timer__number\" data-v-59262732>" + _vm._ssrEscape(_vm._s(_vm.time.hours)) + "</div> " + (_vm.time.hours != 1 ? "<div class=\"timer__small\" data-v-59262732>" + _vm._ssrEscape(_vm._s(_vm.$t("hours"))) + "</div>" : "<div class=\"timer__small\" data-v-59262732>" + _vm._ssrEscape(_vm._s(_vm.$t("hour"))) + "</div>") + "</span> <span class=\"timer__separator\" data-v-59262732></span> <span class=\"timer__box\" data-v-59262732><div class=\"timer__number\" data-v-59262732>" + _vm._ssrEscape(_vm._s(_vm.time.minutes)) + "</div> <div class=\"timer__small\" data-v-59262732>" + _vm._ssrEscape(_vm._s(_vm.$t("min"))) + "</div></span> <span class=\"timer__separator\" data-v-59262732></span> <span class=\"timer__box\" data-v-59262732><div class=\"timer__number\" data-v-59262732>" + _vm._ssrEscape(_vm._s(_vm.time.seconds)) + "</div> <div class=\"timer__small\" data-v-59262732>" + _vm._ssrEscape(_vm._s(_vm.$t("sec"))) + "</div></span> "), _vm._ssrNode("<div class=\"timer__edit\" data-v-59262732>", "</div>", [_vm._t("edit-button")], 2)], 2)], 2) : _vm._e();
};
...
const __vue_module_identifier__ = "data-v-59262732";
/* functional template */
