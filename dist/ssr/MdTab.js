...
const MdTab = {
  ...
  data() {
    return {
      mounted: false,
      tabId: this.id || 'tab-' + uniqueId.uniqueId(),
      width: '0px',
      left: '0px'
    };
  },
  ...
  mounted() {
    ...
    this.parentTabs = getClosestVueParent.getClosestVueParent(this.$parent, 'md-tabs');
    this.$nextTick(() => {
      if (!this.parentTabs) {
...
const __vue_module_identifier__ = "data-v-b37bb7b8";
/* functional template */
