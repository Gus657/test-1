...
const MdTooltip = {
  ...
  methods: {
    removeTooltips() {
      this.tooltipElement.removeEventListener(transitionEndEventName.transitionEndEventName, this.removeTooltips);
    ...
    close() {
      ...
      if (this.tooltipElement) {
        this.tooltipElement.removeEventListener(transitionEndEventName.transitionEndEventName, this.removeTooltips);
        this.tooltipElement.addEventListener(transitionEndEventName.transitionEndEventName, this.removeTooltips);
      }
  ...
  mounted() {
    this.$nextTick(() => {
      ...
      if (!deviceHelper.isMobile() || this.displayOnMobile) {
...
const __vue_module_identifier__ = "data-v-15a404d2";
/* functional template */
