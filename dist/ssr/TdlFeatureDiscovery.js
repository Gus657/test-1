...
const TdlFeatureDiscovery = {
  ...
  methods: {
    ...
    scrollToTarget() {
      if (this.elems_.target) {
        if (deviceHelper.isSafari() && deviceHelper.isiOS()) {
...
var __vue_render__ = function () {
  ...
  return _c('div', {
    ...
    style: _vm.cssProps
  }, [_vm._ssrNode("<div class=\"tap-target-wrapper\">", "</div>", [_vm._ssrNode("<div" + _vm._ssrClass("tap-target", [_vm.themeClass]) + ">", "</div>", [_vm._ssrNode("<div" + _vm._ssrClass("tap-target-content", _vm.helperPosition) + ">", "</div>", [_vm._t("default")], 2)]), _vm._ssrNode(" <div class=\"tap-target-wave\"></div>")], 2), _vm._ssrNode(" <div class=\"tdl-feature-backdrop\"></div>")], 2);
};
...
const __vue_module_identifier__ = "data-v-4d219536";
/* functional template */
