...
import { mdiChevronLeft, mdiChevronRight, mdiArrowLeft, mdiArrowRight } from '@mdi/js';
import './uniqueId-5b272221.js';
import './getClosestVueParent-5770502b.js';
import MdBoard from './MdOnboarding.js';
...
var __vue_render__ = function () {
  ...
  }), _vm._v(" "), !_vm.hideDots ? _c('div', _vm._l(_vm.boardList, function (header) {
    return _c('button', {
      key: header.id,
      ref: "boardHeader",
      refInFor: true,
      ...
      on: {
        "click": function ($event) {
          return _vm.setActiveBoard(header, true);
        }
      }
    }, [_c('div', {
      staticClass: "md-board-header-container"
  ...
  })], 1)]) : _vm._e(), _vm._v(" "), !_vm.mdControls ? _c('span', {
    staticStyle: {
      "flex": "1"
    }
