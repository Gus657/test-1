...
import './MdProgress.js';
import { i as isMobile, c as isTablet } from './deviceHelper-575f722e.js';
...
import './tdlTypeaheadCommon-0425e36a.js';
import script from './TdlTypeaheadDialog.js';
import script$1 from './TdlTypeaheadAddNewItem.js';
import 'lodash-es/throttle';
import script$2 from './TdlTypeaheadList.js';
...
var __vue_render__ = function () {
  ...
  }), _vm._v(" "), _vm.hasAfterInputSlot && !_vm.openInputContainer ? _vm._t("mobileAfterInput") : _vm._e(), _vm._v(" "), _c('div', {
    ref: "inputDialog",
    staticClass: "typeahead-dialog__input-container",
    class: [_vm.inputContainerClasses, _vm.themeClass],
    style: _vm.cssProps
  }, [_c('md-whiteframe', {
  ...
  })], 1)] : _vm._e(), _vm._v(" "), _vm.hasAfterInputSlot && _vm.openInputContainer ? _vm._t("mobileAfterInput") : _vm._e()], 2)], 2)], 1)], 1), _vm._v(" "), _vm.loading ? _c('md-progress', {
    key: "stateLoading",
    attrs: {
      "md-indeterminate": ""
    }
...
var __vue_render__$1 = function () {
  ...
  }) : _vm._e(), _vm._v(" "), _vm.addNewItemElement.iconset ? _c('md-icon', {
    attrs: {
...
var __vue_render__$2 = function () {
  ...
  }, [_vm.hasBeforeInputSlot ? _vm._t("desktopBeforeInput") : _vm._e(), _vm._v(" "), _c('md-input', {
    ref: "input",
  ...
  }), _vm._v(" "), _vm.showSearchHint ? _c('md-icon', {
    staticClass: "typeahead-list__search-hint",
    attrs: {
      "icon-svg": _vm.mdiMagnifyIcon
    }
  }) : _vm._e(), _vm._v(" "), _vm.hasAfterInputSlot ? _vm._t("desktopAfterInput") : _vm._e()], 2), _vm._v(" "), _vm.loading ? _c('md-progress', {
    key: "stateLoading",
    attrs: {
      "md-indeterminate": ""
    }
  }) : _vm._e(), _vm._v(" "), _c('md-list', {
    ref: "list",
...
}, __vue_inject_styles__$2, __vue_script__$2, __vue_scope_id__$2, __vue_is_functional_template__$2, __vue_module_identifier__$2, false, __vue_create_injector__, undefined, undefined);
...
const TdlTypeahead = {
  ...
  props: {
    ...
    addNewItemSlotPosition: {
      type: String,
      default: isMobile() || isTablet() ? 'top' : 'bottom'
    },
  ...
  methods: {
    ...
    doFetchList(query) {
      ...
      Promise.race([this.fetchList(query), timeoutPromise]).then(response => {
        this.baseList = isArray(response) ? {
          $default: response
        } : response;
...
}, __vue_inject_styles__$3, __vue_script__$3, __vue_scope_id__$3, __vue_is_functional_template__$3, __vue_module_identifier__$3, false, __vue_create_injector__, undefined, undefined);
