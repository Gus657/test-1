...
const MdSpeedDial = {
  ...
  computed: {
    classes() {
      let classes = {
        ...
        'md-animation-enabled': this.mdOpen !== 'mounted'
      };
  ...
  mounted() {
    this.$nextTick(() => {
      ...
      if (this.mdOpen === 'mounted') {
        setTimeout(() => this.toggleSpeedDial(), 500);
      } else if (this.mdOpen === 'click') {
...
/* script */
const __vue_script__ = MdSpeedDial;
/* template */
