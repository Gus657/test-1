    ...
    <nav class="md-boards-navigation" :class="navigationClasses" ref="boardNavigation">
      ...
      <md-button
        ...
        <div class="md-board-header-container">
          <md-icon class="md-control" :icon-svg="mdiChevronLeftIcon"></md-icon>
        </div>
      </md-button>
      ...
      <md-button
        ...
        @click="moveNextBoard()">
        <div class="md-board-header-container">
          <md-icon class="md-control" :icon-svg="mdiChevronRightIcon"></md-icon>
        </div>
      </md-button>
...
<script>
  ...
  import mdBoardsTheme from './mdBoards-theme.scss';
  ...
  export default {
    ...
    created: function() {
      this.$root.$emit("component-created", { name: "mdBoards", theme: mdBoardsTheme });
    },
    methods: {
